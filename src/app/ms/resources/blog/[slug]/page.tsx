...
import { blogPostsMs, getPostBySlugMs } from "@/app/resources/blog/posts.bm";
import type { BlogBlock } from "@/app/resources/blog/posts";
...
export async function generateMetadata({
  ...
  const post = getPostBySlugMs(slug);
      ...
      return (
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/ms/financing-hp#calculator"
...
export default async function BlogPostPage({
  ...
  const others = blogPostsMs.filter((p) => p.slug !== post.slug);
