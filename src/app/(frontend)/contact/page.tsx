...
export default async function Contact() {
  ...
  const hoursDays = settings?.operatingHours?.days || "Mon – Fri";
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-10 lg:px-16">
            ...
            <div className="lg:col-span-2">
              <Reveal>
                ...
                <div className="space-y-8">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[2px] text-white/50 mb-2">Address</p>
                  ...
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[2px] text-white/50 mb-2">Office</p>
                  ...
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-[2px] text-white/50 mb-2">Hours</p>
          ...
          <Reveal delay={0.14}>
            <div className="mt-10 bg-white rounded-xl p-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
              ...
              <a href="/apply" target="_blank" rel="noopener noreferrer" className="text-[#EE4720] text-[14px] font-semibold whitespace-nowrap">
                Apply Now
              </a>
            </div>
          </Reveal>
