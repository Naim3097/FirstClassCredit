...
export default async function AboutMs() {
  const partner = await getAboutPartner("ms");
  const partnerLogo =
  ...
  return (
    <>
      ...
      <PartnerSection
        eyebrow={partner?.eyebrow || "Rakan kami"}
        heading={partner?.heading || "Dikuasakan oleh JomKaki Motor"}
        logoUrl={partnerLogo}
        logoAlt="JomKaki Motor"
        linkLabel={partner?.linkLabel || "Lawati JomKaki Motor"}
        linkUrl={partner?.linkUrl || "#"}
        vendorLabel="Rakan vendor rasmi"
        body={
          partner?.body ? (
            ...
            <>
              <p>
                Di First Class Credit, kami komited untuk menjadikan setiap naik
                taraf anda semudah mungkin. Bagi membawa penyelesaian kewangan
                kami terus kepada anda, kami dengan bangganya bekerjasama dengan
                JomKaki Motor.
              </p>
              <p>
                Sebagai rakan vendor rasmi kami, JomKaki Motor menjadi destinasi
                utama anda untuk mengakses pembiayaan Sewa Beli (HP) kami. Sama
                ada anda ingin turun ke jalan raya dengan motosikal baharu atau
                menaik taraf peranti dengan smartphone terkini, anda boleh
                memohon dan menggunakan pelan pembiayaan fleksibel kami terus
                menerusi JomKaki Motor. Bersama-sama, kami memastikan pengalaman
                yang lancar dan tanpa kerumitan dari permohonan sehingga
                pemilikan.
              </p>
            </>
          )
