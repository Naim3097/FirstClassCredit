...
const FALLBACK_ELIGIBILITY = [
  ...
  { icon: "income", label: "Pendapatan Minimum", value: "Gaji bulanan asas RM1,500" },
  {
    ...
    label: "Dokumen",
    value:
      "Salinan NRIC, slip gaji 3 bulan terkini, penyata KWSP terkini atau penyata bank 3 bulan terkini",
  },
];
...
export default async function FinancingHPMs() {
  const [elig, settings, faqs] = await Promise.all([
    getEligibility("ms"),
    getSiteSettings("ms"),
    getFAQs("ms", "motorcycle-page"),
  ]);
